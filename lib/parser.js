            ...
            if (isInContextOf('2.16.840.1.113883.10.20.1.10')) {
                ...
                this._self = {
                    ...
                    entryRelationship: function (node) {
                        ...
                        proto.control.push(new Triplet(node, new EntryRelationship(null, null), templateId));
                    },
                };
                this._self.prototype = proto;
            } else {
...
var genericProcedureHandlder = function (procedure) {
    ...
    return {
        ...
        participant: function (node) {
            proto.control.push(new Triplet(node, new Participant(null)));
...
var Act = function (resource) {
    ...
    this.templateId = function (node) {
        ...
        case '2.16.840.1.113883.10.20.1.27': //Problem act
            ...
            patient = findPatient(proto.bundle);
            condition = makeAndStore('Condition', patient, null);

            if (clinicalImpression && clinicalImpression.resourceType === 'ClinicalImpression') {
        ...
        case '2.16.840.1.113883.3.62.3.18.1':
            ...
            // Convert ProcedureRequest -> Procedure
            procedureRequest = makeAndStore('Procedure', null, findPatient(proto.bundle));
...
var ClinicalDocument = function (patientId, parserStream) {
    ...
    this.component = function (node) {
        ...
        /* Continuity Of Care but not C32 */
        if (_.contains(templateId, ccdTemplateId) && !_.contains(templateId, c32TemplateId)) {
...
module.exports = {
    CcdParserStream: CcdParserStream,
    CcdHandler: CcdHandler
};
